 ...
 * @property {boolean} progressBar - Show a progress bar at the bottom of the toast.
...
class Toastify {
     ...
     * @param {boolean} progressBar - Show a progress bar at the bottom of the toast.
    ...
    _buildToast() {
        ...
        innerDivElement.classList.add(...['inner']);
        // Adding the toast message/node
        if (this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE) {
            // If we have a valid node, we insert it
            innerDivElement.appendChild(this.options.node)
        } else {
            if (this.options.escapeMarkup) {
                innerDivElement.innerText = this.options.text;
            } else {
                innerDivElement.innerHTML = this.options.text;
            }
            ...
            if (this.options.avatar !== "") {
                ...
                if (this.options.position === "left") {
                    ...
                    innerDivElement.appendChild(avatarElement);
                } else {
                    // Adding close icon on the right of content
                    innerDivElement.insertAdjacentElement("afterbegin", avatarElement);
                }
            }
        ...
        if (this.options.close === true) {
            ...
            if ((this.options.position === "left") && width > 360) {
                // Adding close icon on the left of content
                innerDivElement.insertAdjacentElement("afterbegin", closeElement);
            } else {
                // Adding close icon on the right of content
                innerDivElement.appendChild(closeElement);
            }
        }
        ...
        if (this.options.progressBar) {
            ...
            progressBar.style.setProperty('--animation-duration', `${this.options.duration}ms`);
